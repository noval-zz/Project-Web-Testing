...
<head>
  ...
  <title>Edit Profil — {{ $user->nama ?? $user->username }}</title>
    ...
    <div class="col-lg-9">
      ...
      <div class="card card-custom bg-white">
        ...
        <div class="card-header card-header-futuristic py-4 px-4 d-flex justify-content-between align-items-center">
          ...
          <a href="{{ route('teknisi.dashboard') }}" class="btn btn-glass btn-sm fw-medium">
        ...
        <div class="card-body p-4 p-md-5">
          ...
          <div class="mb-5">
            ...
            <form action="{{ route('teknisi.profil.foto') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="d-flex align-items-center gap-3 avatar-container">
                @if ($user->foto_profil)
                  <img src="{{ asset('storage/' . $user->foto_profil) }}" class="avatar-preview" alt="Foto profil">
                @else
            ...
            <form action="{{ route('teknisi.profil.update') }}" method="POST">
              ...
              <div class="row">
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" class="form-control text-muted" value="{{ $user->username }}" disabled style="background-color: #e2e8f0; opacity: 0.7;">
                ...
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" class="form-control" name="nama" value="{{ old('nama', $user->nama) }}" required placeholder="Nama lengkap Anda">
                </div>

                <div class="col-md-12 mb-4">
                  <label class="form-label">Alamat Email</label>
                  <input type="email" class="form-control" name="email" value="{{ old('email', $user->email) }}" placeholder="email@contoh.com">
                </div>
              </div>
          ...
          <div>
            ...
            <form action="{{ route('teknisi.profil.password') }}" method="POST">
              @csrf
