  ...
  <div class="container">
    ...
    <div class="right">
      ...
      <div class="login-box">
        ...
        <form action="<?php echo e(route('reset.password.post')); ?>" method="POST" id="resetForm">
          <?php echo csrf_field(); ?>
          ...
          <div class="input-group">
            <input type="text"
                   ...
                   value="<?php echo e(old('kontak_verifikasi')); ?>"
                   required
                   autocomplete="off">
          ...
          <?php $__errorArgs = ['kontak_verifikasi'];
...
<?php /**PATH C:\xampp\htdocs\aqas\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>