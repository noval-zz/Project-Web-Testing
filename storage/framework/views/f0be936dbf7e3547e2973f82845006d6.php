...
<?php $__env->startSection('page-subtitle', 'Selamat datang, ' . (Auth::user()->nama ?? Auth::user()->username)); ?>
...
<div class="stat-grid">
    <div class="stat-card purple">
        ...
        <div class="stat-value"><?php echo e($totalUser); ?></div>
    ...
    <div class="stat-card orange">
        ...
        <div class="stat-value"><?php echo e($totalAdmin); ?></div>
...
<div style="display:grid;grid-template-columns:2fr 1fr;gap:20px;margin-bottom:24px">
    ...
    <div class="card">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">Statistik laporan tahun <?php echo e(date('Y')); ?></div>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('superadmin.audit-log.index')); ?>" class="btn btn-secondary btn-sm">Lihat Semua</a>
        </div>
        <div style="display:flex;flex-direction:column;gap:10px">
            ...
            <div style="display:flex;align-items:flex-start;gap:10px;padding:10px;border-radius:8px;background:rgba(255,255,255,0.03)">
                ...
                <div style="min-width:0">
                    <div style="font-size:13px;font-weight:600;color:var(--text-primary)"><?php echo e($log->aktivitas); ?></div>
                    <div style="font-size:11px;color:var(--text-muted)"><?php echo e($log->user?->username ?? 'System'); ?> · <?php echo e($log->created_at?->diffForHumans()); ?></div>
                </div>
            </div>
...
<div class="card">
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap">
        ...
        <a href="<?php echo e(route('superadmin.gedung.create')); ?>" class="btn btn-secondary">
            <i class="fa-solid fa-building-circle-arrow-right"></i> Tambah Gedung
        </a>
        <a href="<?php echo e(route('superadmin.kategori.create')); ?>" class="btn btn-secondary">
            <i class="fa-solid fa-plus"></i> Tambah Kategori
        </a>
        <a href="<?php echo e(route('superadmin.backup.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('superadmin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel - Copy (2)\resources\views/superadmin/dashboard.blade.php ENDPATH**/ ?>