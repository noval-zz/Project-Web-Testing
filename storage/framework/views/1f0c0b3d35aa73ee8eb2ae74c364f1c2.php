...
<div class="mhs-dashboard">
  ...
  <div class="welcome-banner">
    <div class="welcome-text">
      ...
      <div class="sub-info">
        ...
        <span class="info-item">🪪 <?php echo e($roleLabel); ?>: <?php echo e($nim); ?></span>
  ...
  <div class="stats-grid">
    ...
    <div class="stat-card ditolak" style="background:#fff;border-left:4px solid var(--danger);">
      ...
      <div class="stat-info">
        <div class="stat-number"><?php echo e($ditolak ?? 0); ?></div>
  ...
  <div class="progress-section">
    ...
    <?php if($laporanAktif): ?>
      ...
      <div style="background:#EFF6FF;border-radius:10px;padding:12px 16px;margin-bottom:20px;font-size:13px;color:#1E3A5F;display:flex;align-items:center;gap:10px;">
        ...
        <div>
          <strong><?php echo e($laporanAktif->kategori->nama_kategori ?? 'Fasilitas'); ?><?php echo e($laporanAktif->subkategori ? ' — ' . $laporanAktif->subkategori->nama_sub_kategori : ''); ?></strong>
            ...
            <tr>
              ...
              <td>
                <div class="laporan-title">
                  <?php echo e(ucfirst(($lap->kategori->nama_kategori ?? 'Fasilitas') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : ''))); ?>
      ...
      <?php else: ?>
        <div class="timeline">
          ...
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <div class="t-title">Akun <?php echo e(ucfirst($user->role)); ?> Aktif</div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/mahasiswa/dashboard.blade.php ENDPATH**/ ?>