...
<?php $__env->startSection('profile-role'); ?> <?php echo e($user->role === 'dosen' ? 'NIDN/NIP' : 'NIM'); ?>: <?php echo e($mhs->Nim ?? ''); ?> <?php $__env->stopSection(); ?>
                ...
                <div class="report-item <?php echo e($isFirst ? 'active' : ''); ?>"
                    ...
                    <div class="item-top">
                        ...
                        <span class="mini-badge <?php echo e($miniBadgeClass($status)); ?>">
                            <?php echo e($status === 'Selesai' ? 'Selesai' : ($status === 'Dalam Pengerjaan' ? 'Dikerjakan' : ($status === 'Sedang Diperbaiki' ? 'Diverifikasi' : ($status === 'Ditolak' ? 'Ditolak' : 'Menunggu')))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/mahasiswa/pantau_laporan.blade.php ENDPATH**/ ?>