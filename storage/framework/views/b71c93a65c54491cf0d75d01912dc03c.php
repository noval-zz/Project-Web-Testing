      ...
      <div class="tek-panel" style="margin-bottom:16px;">
        ...
        <div class="tek-panel-body">
          ...
          <div class="info-group">
            ...
            <div class="info-value"><?php echo e(ucfirst(($laporan->kategori->nama_kategori ?? '-') . ($laporan->subkategori ? ' — ' . $laporan->subkategori->nama_sub_kategori : ''))); ?></div>
          </div>
          ...
          <div class="info-group">
            ...
            <div class="info-value" style="display:flex; align-items:center; gap:10px;">
              <?php if($laporan->mahasiswa?->foto_profil): ?>
                <img src="<?php echo e(asset('storage/' . $laporan->mahasiswa->foto_profil)); ?>" style="width:32px; height:32px; border-radius:50%; object-fit:cover; border:1px solid #e2e8f0;" alt="Foto">
              <?php else: ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/Teknisi/selesai.blade.php ENDPATH**/ ?>