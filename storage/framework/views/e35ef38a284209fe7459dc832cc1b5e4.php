...
<div class="dash-wrap">
          ...
          <table class="dash-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div style="display:flex;align-items:center;gap:8px">
                    <?php if($lap->mahasiswa?->foto_profil): ?>
                      <img src="<?php echo e(asset('storage/' . $lap->mahasiswa->foto_profil)); ?>" style="width:28px;height:28px;border-radius:50%;object-fit:cover;border:1px solid #e2e8f0;" alt="Foto">
                    <?php else: ?>
                ...
                <td>
                  <span class="badge badge-blue"><?php echo e(($lap->kategori?->nama_kategori ?? '-') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : '')); ?></span>
                </td>
                <td>
                  <?php
  ...
  <div class="dash-row dash-row-2-2">
          ...
          <div class="prioritas-item">
            ...
            <div class="prioritas-body">
              <div class="prioritas-desc">
                <?php echo e(($lap->kategori?->nama_kategori ?? 'Kerusakan') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : '')); ?> —
    ...
    <div class="dash-card">
      ...
      <div class="qa-grid">
        <a href="<?php echo e(route('admin.verifikasi.index')); ?>" class="qa-item">
          <div class="qa-icon"><i class="fa-solid fa-clipboard-check"></i></div>
          <span class="qa-label">Verifikasi Laporan</span>
        </a>
        <a href="<?php echo e(route('admin.laporan.semua')); ?>" class="qa-item">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>