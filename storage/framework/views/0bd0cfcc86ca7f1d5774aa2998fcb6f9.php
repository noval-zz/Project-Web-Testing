...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Super Admin'); ?> — Sistem Pelaporan Fasilitas</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('superadmin.akun.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.akun.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-users-gear"></i> Manajemen Akun
        </a>

        <div class="nav-section-title" style="margin-top:8px">Konfigurasi</div>
        <a href="<?php echo e(route('superadmin.gedung.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.gedung.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-building"></i> Gedung
        </a>
        <a href="<?php echo e(route('superadmin.lantai.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.lantai.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-layer-group"></i> Lantai
        </a>
        <a href="<?php echo e(route('superadmin.ruangan.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.ruangan.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-door-open"></i> Ruangan
        </a>
        <a href="<?php echo e(route('superadmin.kategori.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.kategori.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-tags"></i> Kategori Fasilitas
        </a>

        <div class="nav-section-title" style="margin-top:8px">Sistem</div>
        <a href="<?php echo e(route('superadmin.audit-log.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.audit-log.*') ? 'active' : ''); ?>">
            <i class="fa-solid fa-clipboard-list"></i> Log & Audit
        </a>
        <a href="<?php echo e(route('superadmin.backup.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('superadmin.backup.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            <?php if(Auth::user()->foto_profil): ?>
                <img src="<?php echo e(asset('storage/profil/' . Auth::user()->foto_profil)); ?>"
            ...
            <div class="sidebar-user-info">
                <div class="sidebar-user-name" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:140px">
                    <?php echo e(Auth::user()->nama ?? Auth::user()->username); ?>
    ...
    <header class="topbar">
        <div style="display:flex;align-items:center;gap:14px">
            ...
            <div>
                ...
                <div style="font-size:12px;color:var(--text-muted)"><?php echo $__env->yieldContent('page-subtitle', ''); ?></div>
            </div>
        </div>

        <div class="topbar-actions">
            <a href="<?php echo e(route('superadmin.profil.edit')); ?>" class="topbar-icon-btn" title="Profil">
...
<?php /**PATH C:\xampp\htdocs\laravel - Copy (2)\resources\views/superadmin/layouts/app.blade.php ENDPATH**/ ?>