<?php $__env->startSection('title', 'Verifikasi Laporan — Sistem Pelaporan Fasilitas'); ?>
...
<?php $__env->startSection('sidebar-menu'); ?>
  ...
  <a href="<?php echo e(route('admin.laporan.semua')); ?>">
...
<?php $__env->startSection('profile-buttons'); ?>
  ...
  <a href="<?php echo e(route('admin.profil.edit')); ?>"><button>Edit Profile</button></a>
<?php $__env->stopSection(); ?>
...
<div class="rw-wrap">
    ...
    <div class="rw-hero-inner">
      ...
      <div class="rw-hero-stats">
        <div class="rw-hero-pill">
          ...
          <?php echo e($laporanList->total()); ?> Menunggu Verifikasi
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="rw-body">
    ...
    <?php if(session('success')): ?>
      <div class="rw-alert">
        <i class="fa-solid fa-circle-check" style="color:#10B981;font-size:16px"></i> <?php echo e(session('success')); ?>
    ...
    <div class="rw-filter-card">
      <form method="GET" action="<?php echo e(route('admin.verifikasi.index')); ?>" class="rw-filter-form">
        ...
        <div class="rw-filter-actions">
          ...
          <a href="<?php echo e(route('admin.verifikasi.index')); ?>" class="rw-btn rw-btn-ghost">
            ...
            <tbody>
              ...
              <tr onclick="openDetailModal(<?php echo e($lap->id_laporan); ?>)" title="Klik untuk lihat detail">
                ...
                <td data-label="Pelapor">
                  <div class="rw-avatar">
                    <?php if($lap->mahasiswa?->foto_profil): ?>
                      <img src="<?php echo e(asset('storage/' . $lap->mahasiswa->foto_profil)); ?>" class="rw-avatar-circle" style="object-fit:cover; border:1px solid #e2e8f0;" alt="Foto">
                    <?php else: ?>
                    ...
                    <div>
                      ...
                      <div class="rw-avatar-nim"><?php echo e($lap->mahasiswa?->Nim ?? ''); ?></div>
                    </div>
                  </div>
                </td>
                ...
                <td data-label="Kategori">
                  <span class="rw-badge rw-badge-blue">
                    <?php echo e(($lap->kategori?->nama_kategori ?? '–') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : '')); ?>
                ...
                <td data-label="Aksi" onclick="event.stopPropagation()" style="text-align:right">
                  <div class="rw-inline-actions">
                    <form action="<?php echo e(route('admin.verifikasi.setuju', $lap->id_laporan)); ?>" method="POST" style="display:inline">
                      <?php echo csrf_field(); ?>
                      <button type="submit" class="rw-btn rw-btn-success" style="padding:6px 12px;font-size:11px" title="Terima & Kirim ke Teknisi">
                        <i class="fa-solid fa-check"></i> Terima
                      </button>
                    </form>
                    <form action="<?php echo e(route('admin.verifikasi.tolak', $lap->id_laporan)); ?>" method="POST" style="display:inline">
                      <?php echo csrf_field(); ?>
                    ...
                    <form action="<?php echo e(route('admin.verifikasi.hapus', $lap->id_laporan)); ?>" method="POST" style="display:inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laporan ini secara permanen?')">
                      <?php echo csrf_field(); ?>
...
const laporanData = [
  ...
  ?>
  {
    ...
    pelapor: "<?php echo e(e($lap->mahasiswa?->Nama_mahasiswa ?? 'Anonim')); ?>",
    nim: "<?php echo e(e($lap->mahasiswa?->Nim ?? '–')); ?>",
    tanggal: "<?php echo e($lap->created_at?->format('d M Y, H:i')); ?>",
    deskripsi: <?php echo json_encode($lap->deskripsi); ?>,
    lokasi: "<?php echo e(e($lokasiStr)); ?>",
    kategori: "<?php echo e(e(($lap->kategori?->nama_kategori ?? '–') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : ''))); ?>",
    tingkat: "<?php echo e($lap->Tingkat_Kerusakan); ?>",
    foto: "<?php echo e($fotoUrl); ?>",
    pelapor_foto: "<?php echo e($pelaporFotoUrl); ?>"
  },
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
];
...
function openDetailModal(id) {
  ...
  const routeSetuju = "<?php echo e(route('admin.verifikasi.setuju', ':id')); ?>".replace(':id', d.id);
  const routeTolak  = "<?php echo e(route('admin.verifikasi.tolak', ':id')); ?>".replace(':id', d.id);
  const routeHapus  = "<?php echo e(route('admin.verifikasi.hapus', ':id')); ?>".replace(':id', d.id);
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/admin/verifikasi.blade.php ENDPATH**/ ?>