        ...
        <div class="tek-panel-body">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
            ...
            <div class="info-group">
              ...
              <div class="info-value"><?php echo e(ucfirst($laporan->kategori->nama_kategori ?? 'Tidak diketahui')); ?></div>
            </div>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
            <div class="info-group">
              ...
              <div class="info-value"><?php echo e($laporan->mahasiswa->Nama_mahasiswa ?? 'Anonim'); ?></div>
            </div>
            <div class="info-group">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel - Copy (2)\resources\views/Teknisi/detail.blade.php ENDPATH**/ ?>