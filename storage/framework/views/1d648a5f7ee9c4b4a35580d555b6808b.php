        ...
        <div class="kerusakan-group">
          ...
          <div class="kerusakan-pill rendah">
            <input type="radio" name="Tingkat_Kerusakan" id="tk-rendah" value="Rendah"
              <?php echo e(old('Tingkat_Kerusakan') == 'Rendah' ? 'checked' : ''); ?> required>
          ...
          <div class="kerusakan-pill sedang">
            <input type="radio" name="Tingkat_Kerusakan" id="tk-sedang" value="Sedang"
              <?php echo e(old('Tingkat_Kerusakan') == 'Sedang' ? 'checked' : ''); ?> required>
          ...
          <div class="kerusakan-pill parah">
            <input type="radio" name="Tingkat_Kerusakan" id="tk-parah" value="Parah"
              <?php echo e(old('Tingkat_Kerusakan') == 'Parah' ? 'checked' : ''); ?> required>
...
<script>
  ...
  const subKategoriData = <?php echo $subKategoriJson; ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/laporan/create.blade.php ENDPATH**/ ?>