...
<?php $__env->startSection('sidebar-menu'); ?>
  ...
  <a href="<?php echo e(route('teknisi.profil.edit')); ?>">
              ...
              <td style="font-size:12.5px;color:var(--gray-600);">
                <div style="display:flex; align-items:center; gap:8px;">
                  <?php if($lap->mahasiswa?->foto_profil): ?>
                    <img src="<?php echo e(asset('storage/' . $lap->mahasiswa->foto_profil)); ?>" style="width:28px; height:28px; border-radius:50%; object-fit:cover; border:1px solid #e5e7eb;" alt="Foto">
                  <?php else: ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/Teknisi/tugas.blade.php ENDPATH**/ ?>