          ...
          <table class="tek-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span class="status-badge <?php echo e($stClass); ?>"><?php echo e($displayStatus); ?></span></td>
            ...
            <div class="tek-activity-timeline">
              ...
              <div class="tak-item">
                ...
                <div class="tak-content">
                  <div class="tak-title"><?php echo e(ucfirst(($lap->kategori->nama_kategori ?? 'Fasilitas') . ($lap->subkategori ? ' — ' . $lap->subkategori->nama_sub_kategori : ''))); ?></div>
                  <div class="tak-sub">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\aqas\resources\views/Teknisi/dashboard.blade.php ENDPATH**/ ?>